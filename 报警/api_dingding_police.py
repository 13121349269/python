...
contacts = "韩静"
tel = "xxxxxxx"
#url = "https://xxxxx.com/api/v1/gateway/Home/ContractSummary?market=BTCUSDT&marketCode=BTCUSDT&contractCode=BTCUSDT&lang=cn"
# url = "https://xxxx.com/v1/api/paycenter/checkapi"
...
def dingding(massage):
    dingding_url = "https://oapi.dingtalk.com/robot/send?access_token=xxxxxxxxx"
